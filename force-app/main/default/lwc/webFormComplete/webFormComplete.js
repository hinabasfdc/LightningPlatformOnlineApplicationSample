...
export default class WebFormComplete extends LightningElement {
  ...
  get message() {
    return (this.applicationTemplate.fields[fnAT_THANKYOUPAGEDESCRIPTION_FIELD].value) ? this._decodeHtml(this.applicationTemplate.fields[fnAT_THANKYOUPAGEDESCRIPTION_FIELD].value) : false;
  }

  /**
   * @description : 自動採番される Name 項目の値を取得
   */
  @wire(getRecord, { recordId: '$createdAppRecordId', fields: GETRECORD_FIELDS })
